                    ...
                    <Link href="/" data-testid="link-home">
                        <div className="flex items-center gap-2 cursor-pointer hover:opacity-90 transition-opacity">
                            <div className="w-[45px] h-[52px] md:w-[60px] md:h-[70px] lg:w-[67px] lg:h-[77.33px] rounded-lg bg-primary flex items-center justify-center">
                                <span className="text-primary-foreground font-semibold text-[24px] md:text-[42px] lg:text-[44px]">
                                    A
                                </span>
                            </div>
                ...
                <Card className="w-full max-w-[490px] bg-white border-none shadow-sm rounded-[15px] flex flex-col justify-center z-10">
                    <CardContent className="flex flex-col items-center px-4 sm:px-8 lg:px-10 py-10 sm:py-12">
                        ...
                        <div className="mb-5 sm:mb-6">
                            <MailCheck
                                className="w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] text-[#30A66F]"
                                strokeWidth={1.5}
                            />
                        </div>
                        ...
                        <p className="text-center text-[#111815] text-[13px] sm:text-[15px] lg:text-[16px] mb-2 leading-relaxed px-2">
                            ...
                            <span className="text-[#11181599]">your@gmail.com</span>{" "}
                            <CheckCircle2 className="inline-block w-[14px] h-[14px] sm:w-4 sm:h-4 text-[#11181599] ml-1 mb-0.5" />
                        </p>
                        ...
                        <Form {...form}>
                            ...
                            >
                                ...
                                <div className="text-center text-[13px] sm:text-[15px] lg:text-[18px] text-[#111815] mb-8">
                                    ...
                                    <button
                                        type="button"
                                        className="text-[#C38322] font-semibold hover:underline"
                                    >
                                        Resend Code
                                    </button>
                                    <div className="mt-1.5 sm:mt-2 text-[13px] sm:text-[15px] lg:text-[18px]">
                                        (00 : 59)
                                    </div>
                                </div>
                                ...
                                <Link href="/login">
                                    <button
                                        type="button"
                                        className="mt-5 sm:mt-6 text-[#30A66F] font-semibold text-[14px] sm:text-[16px] lg:text-[18px] hover:underline"
                                    >
                                        Back to Email entry
                                    </button>
                                </Link>
